        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SalePrice = table.Column<decimal>(type: "decimal(8,2)", nullable: false),
                    RentPrice = table.Column<decimal>(type: "decimal(8,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BorrowinTransactions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BorrowinTransactions_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BorrowinTransactions_Books_BookId",
                        column: x => x.BookId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PurchaseTransactions_Books_BookId",
                        column: x => x.BookId,
                        principalTable: "Books",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Books_ShopingCartId",
                table: "Books",
                column: "ShopingCartId");

            migrationBuilder.CreateIndex(
                name: "IX_BorrowinTransactions_BookId",
                table: "BorrowinTransactions",
                column: "BookId");

            migrationBuilder.CreateIndex(
                name: "IX_BorrowinTransactions_UserId",
                table: "BorrowinTransactions",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_PurchaseTransactions_BookId",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Books_ShopingCarts_ShopingCartId",
                table: "Books",
                column: "ShopingCartId",
